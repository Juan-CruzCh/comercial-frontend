  ...
  return (
    <div className="p-6 space-y-8 bg-gray-50 min-h-screen">
      ...
      <form
        ...
        onSubmit={handleSubmit(btnIngreso)}
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            />
            {errors.factura && (
              <p className="text-sm text-red-500">{errors.factura.message}</p>
            )}
          </div>
        ...
        <button
          onClick={() => btnIngreso}
          className="mt-4 px-4 py-2 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 transition-all"
        >
          Ingresar
        </button>
      </form>
                  ...
                  <TableRow hover>
                    ...
                    <TableCell align="center">
                      <IconButton
                        color="error"
                        size="small"
                        onClick={() => btnEliminar(item.codigo)}
                      >
                        <DeleteIcon />
                      </IconButton>
                    </TableCell>
