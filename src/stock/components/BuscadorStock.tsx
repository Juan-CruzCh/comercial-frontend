...
import type { BuscadorStockProps } from '../interface/stock';

export const BuscadorStock = ({ unidadSeleccionada, codigo, nombre, categoriaSeleccionada, setCategoriaSeleccionada, setCodigo, setNombre, setUnidadSeleccionada, }: BuscadorStockProps) => {
