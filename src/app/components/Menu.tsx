                        ...
                        <List component="nav" sx={{ flex: 1 }}>
                            ...
                            <Collapse in={openVentas} timeout="auto" unmountOnExit>
                                <List component="div" disablePadding>
                                    <ListItemButton component={Link} to="realizar/venta" sx={{ pl: 4 }}>
                                        <ListItemIcon>
                                            <Receipt />
                                        </ListItemIcon>
                                        <ListItemText
                            ...
                            {/* Inventario */}
                            <ListItemButton onClick={() => setOpenInventario(!openInventario)}>
                                <ListItemIcon>
                                    <Inventory />
                                </ListItemIcon>
                                <ListItemText
                            ...
                            <Collapse in={openInventario} timeout="auto" unmountOnExit>
                                <List component="div" disablePadding>
                                    ...
                                    <ListItemButton component={Link} to="/realizar/ingreso" sx={{ pl: 4 }}>
                                        <ListItemIcon>
                                            <Store />
                                        </ListItemIcon>
                                        <ListItemText
                                    ...
                                    <ListItemButton component={Link} to="/listar/stock" sx={{ pl: 4 }} >
                                        <ListItemIcon>
                                            <Inventory />
                                        </ListItemIcon>
                                        <ListItemText
